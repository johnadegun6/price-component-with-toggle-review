      ...
      <section className="p-5">
        <div className=" flex flex-wrap flex-col justify-center gap-8 text-center">
          <article className=" p-8 rounded bg-white shadow ">
            ...
            <button className=" border-2 linear-gradient text-white py-2 w-full rounded-lg shadow border-2 border-white uppercase cursor-pointer hover:bg-transparent hover:text-white transition-all duration-200">Learn More</button>
          </article>
          ...
          <article className="linear-gradient p-8 rounded-shadow ">
            ...
            <button className=" bg-white text-slate-800 py-2 w-full rounded-lg shadow border-2 border-white uppercase cursor-pointer hover:bg-transparent hover:text-white transition-all duration-200 ">Learn More</button>
          </article>
          ...
          <article className=" p-8 rounded bg-white shadow ">
            ...
            <button className="linear-gradient  text-white py-2 w-full rounded-lg shadow border-2 border-white uppercase cursor-pointer hover:bg-transparent hover:text-white transition-all duration-200">Learn More</button>
          </article>
        </div>
